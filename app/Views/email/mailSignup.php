                        ...
                        <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                            <div style="text-align:center; margin:0 15px 34px 15px">
                                <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                    <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700"><?php echo lang("Text.e_signup_hi") . ' ' . @$person . ', ' . lang("Text.e_signup_welcome_company") . ' ' . @$pageTitle; ?></p>
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td align="start" valign="start" style="padding-bottom: 10px;">
                            <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                                ...
                                <div style="display:flex">
                                    <div>
                                        <p style="color:#5E6278; font-size: 13px; font-weight: 500; padding-top:3px; margin:0;font-family:Arial,Helvetica,sans-serif">
                                            <?php echo lang("Text.e_signup_complete_account_info"); ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
