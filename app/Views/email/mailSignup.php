                                ...
                                <div style="display:flex">
                                    <div>
                                        <span style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">
                                            <?php echo lang("Text.eccba_complete_account"); ?>
                                        </span>
                                        <p style="color:#5E6278; font-size: 13px; font-weight: 500; padding-top:3px; margin:0;font-family:Arial,Helvetica,sans-serif">
                                        Hemos registrado su cuenta de cliente utilizando la dirección de correo electrónico proporcionada. Haga clic a continuación para verificar su dirección de correo electrónico. Si no solicitó verificar esta dirección, puede ignorar este correo electrónico. 
                                        </p>
                                    </div>
                                </div>
