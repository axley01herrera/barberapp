<div class="card card-flush mb-6 mb-xl-9">
    ...
    <div class="card-header mt-6">
        ...
        <div class="card-title flex-column">
            <h2 class="mb-1"><?php echo lang('Text.cp_cust_profile_tab_info_title'); ?></h2>
            <div class="fs-6 fw-semibold text-muted"><?php echo lang('Text.cp_cust_profile_tab_info_subtitle'); ?></div>
        </div>
        <!-- Card toolbar -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div id="kt_image_input_profile<?php echo $uniqid; ?>" class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(http://barberapp/public/assets/media/svg/avatars/blank.svg)">
                            ...
                            <?php } ?>
                            <!-- Edit Button -->
                            <label class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="<?php echo lang('Text.cp_cust_change_avatar') ?>">
                            ...
                            <!-- Remove button -->
                            <?php if (!empty($customer[0]->avatar)) { ?>
                                <span class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" data-bs-dismiss="click" title="<?php echo lang('Text.cp_cust_remove_avatar'); ?>">
                    ...
                    <!-- last Name -->
                    <div class="col-12 mt-5">
                        <label class="fs-6 fw-semibold" for="txt-lastName<?php echo $uniqid; ?>"><?php echo lang('Text.cp_cust_last_name'); ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 mt-5">
                        <!-- Phone -->
                        <label class="fs-6 fw-semibold" for="txt-phone<?php echo $uniqid; ?>"><?php echo lang('Text.cp_cust_phone'); ?> <span class="text-danger">*</span></label>
