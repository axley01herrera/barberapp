            ...
            <div class="col-12 col-md-6 col-lg-6 mb-5">
                <div class="bg-light-primary bg-opacity-70 rounded-2 px-6 py-5">
                    <div class="m-0">
                        ...
                        <span class="text-gray-500 fw-semibold fs-6"><?php echo sizeof($appointments) . ' ' . lang('Text.cp_cust_future_appointments'); ?></span>
                    </div>
                </div>
            </div>
            <!-- Email Verified -->
                ...
                <?php if ($customer[0]->emailVerified == 1) { ?>
                    <div class="bg-light-success bg-opacity-70 rounded-2 px-6 py-5">
                        <div class="m-0">
                            ...
                            <span class="text-gray-500 fw-semibold fs-6"><?php echo lang('Text.cp_cust_verified_email'); ?></span>
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="bg-light-danger bg-opacity-70 rounded-2 px-6 py-5">
                        <div class="m-0">
                            ...
                            <span class="text-gray-500 fw-semibold fs-6"><?php echo lang('Text.cp_cust_unverified_email'); ?></span>
                        </div>
                    </div>
                <?php } ?>
            </div>
