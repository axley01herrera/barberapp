    ...
    <div class="card-body p-9 pt-4">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 mt-5">
                ...
                <input type="text" id="txt-zip<?php echo $uniqid; ?>" class="form-control number<?php echo $uniqid; ?>" maxlength="5" value="<?php if(!empty($customer[0]->zip)) echo $customer[0]->zip; ?>" disabled="">
            </div>
            <div class="col-12 col-lg-3 mt-5">
                <!-- Country -->
