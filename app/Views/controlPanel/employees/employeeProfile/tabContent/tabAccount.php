<div class="card card-flush mb-6 mb-xl-9">
    ...
    <div class="card-header mt-6">
        ...
        <div class="card-title flex-column">
            <h2 class="mb-1"><?php echo lang('Text.cp_emp_profile_tab_account_title'); ?></h2>
            <div class="fs-6 fw-semibold text-muted"><?php echo lang('Text.cp_emp_profile_tab_account_subtitle'); ?></div>
        </div>
        <!-- Card toolbar -->
                ...
                if ($('#txt-newPassword<?php echo $uniqid; ?>').val() === $('#txt-confirmNewPassword<?php echo $uniqid; ?>').val()) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.error == 0) {
                                simpleSuccessAlert("<?php echo lang("Text.cp_emp_success_update_account"); ?>");
                                reloadEmployeeInfo();
                                employeeProfileTabContent();
