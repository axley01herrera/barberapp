<div class="card card-flush mb-6 mb-xl-9">
    ...
    <div class="card-header mt-6">
        ...
        <div class="card-title flex-column">
            <h2 class="mb-1"><?php echo lang('Text.emp_profile_title'); ?></h2>
            <div class="fs-6 fw-semibold text-muted"><?php echo lang('Text.emp_profile_subtitle'); ?></div>
        </div>
        <!-- Card toolbar -->
    ...
    <div class="card-body p-9 pt-4">
        <div class="row">
            ...
            <div class="col-12 col-lg-6 mt-5">
                ...
                <input type="text" id="txt-address1<?php echo $uniqid; ?>" class="form-control" maxlength="250" value="<?php echo $employee[0]->address1; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- Line 2 -->
                <label class="fs-6 fw-semibold" for="txt-address2<?php echo $uniqid; ?>"><?php echo lang('Text.address2'); ?></label>
                <input type="text" id="txt-address2<?php echo $uniqid; ?>" class="form-control" maxlength="250" value="<?php echo $employee[0]->address2; ?>" disabled />
            </div>
            <div class="col-12 col-lg-3 mt-5">
                <!-- City -->
                <label class="fs-6 fw-semibold" for="txt-city<?php echo $uniqid; ?>"><?php echo lang('Text.city'); ?></label>
                <input type="text" id="txt-city<?php echo $uniqid; ?>" class="form-control" maxlength="250" value="<?php echo $employee[0]->city; ?>" disabled />
            </div>
            <div class="col-12 col-lg-3 mt-5">
                <!-- State -->
                <label class="fs-6 fw-semibold" for="txt-state<?php echo $uniqid; ?>"><?php echo lang('Text.state'); ?></label>
                <input type="text" id="txt-state<?php echo $uniqid; ?>" class="form-control" maxlength="250" value="<?php echo $employee[0]->state; ?>" disabled />
            </div>
            <div class="col-12 col-lg-3 mt-5">
                <!-- Zip -->
            ...
            <div class="col-12 col-lg-3 mt-5">
                ...
                <input type="text" id="txt-country<?php echo $uniqid; ?>" class="form-control" maxlength="250" value="<?php echo $employee[0]->country; ?>" disabled />
            </div>
        </div>
        <div class="row">
