            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        <h1 class="fw-bolder fs-2hx text-gray-900 mb-4"><?php echo lang('Text.ops'); ?></h1>
                        <div class="fw-semibold fs-6 text-gray-500 mb-7"><?php echo lang('Text.something_has_not_gone_well'); ?></div>
                        <div class="mb-3">
