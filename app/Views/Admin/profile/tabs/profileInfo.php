    ...
    <div class="col-12 col-md-8 col-lg-4">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                ...
                <input type="text" id="txt-name<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" maxlength="45" value="<?php echo $profile[0]->name; ?>" disabled />
            </div>
            <div class="col-12 mt-5">
                <!-- Last Name -->
                ...
                <input type="text" id="txt-lastName<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" maxlength="90" value="<?php echo $profile[0]->last_name; ?>" disabled />
            </div>
            <div class="col-12 mt-5">
                <!-- Email -->
