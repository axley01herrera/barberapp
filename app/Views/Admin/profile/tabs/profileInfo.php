<div class="row">
    ...
    <div class="col-12 col-md-8 col-lg-8">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <!-- Email-->
                <label class="fs-6 fw-semibold" for="txt-email<?php echo $uniqid; ?>"><?php echo lang('Text.email'); ?></label>
                <input type="text" id="txt-email<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?> email<?php echo $uniqid; ?>" value="<?php echo $profile[0]->email; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- Primary Phone-->
            ...
            <div class="col-12 col-lg-6 mt-5">
                ...
                <input type="text" id="txt-address1<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" value="<?php echo $profile[0]->address1; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- Line 2 -->
                <label class="fs-6 fw-semibold" for="txt-address2<?php echo $uniqid; ?>"><?php echo lang('Text.address2'); ?></label>
                <input type="text" id="txt-address2<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" value="<?php echo $profile[0]->address2; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- City -->
                <label class="fs-6 fw-semibold" for="txt-city<?php echo $uniqid; ?>"><?php echo lang('Text.city'); ?></label>
                <input type="text" id="txt-city<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" value="<?php echo $profile[0]->city; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- State -->
                <label class="fs-6 fw-semibold" for="txt-state<?php echo $uniqid; ?>"><?php echo lang('Text.state'); ?></label>
                <input type="text" id="txt-state<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" value="<?php echo $profile[0]->state; ?>" disabled />
            </div>
            <div class="col-12 col-lg-6 mt-5">
                <!-- Zip -->
            ...
            <div class="col-12 col-lg-6 mt-5">
                ...
                <input type="text" id="txt-country<?php echo $uniqid; ?>" class="form-control required<?php echo $uniqid; ?>" value="<?php echo $profile[0]->country; ?>" disabled />
            </div>
        </div>
    </div>
</div>
