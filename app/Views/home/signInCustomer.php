                    ...
                    <div class="form w-100">
                        ...
                        <form class="form" id="kt_login">
                            <div class="fv-row mb-4">
                                <input type="text" id="txt-email<?php echo $uniqid; ?>" placeholder="<?php echo lang('Text.email_label'); ?>" autocomplete="off" class="form-control email bg-transparent mb-5 required<?php echo $uniqid; ?>" autofocus />
