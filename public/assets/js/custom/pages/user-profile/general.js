                    ...
                    t.preventDefault(),
                        ...
                        i.classList.contains("btn-success") ? setTimeout((function () {
                            i.removeAttribute("data-kt-indicator"),
                                ...
                                i.querySelector(".indicator-label").innerHTML = "Follow", i.disabled = !1
                        }), 1500) : setTimeout((function () {
                            i.removeAttribute("data-kt-indicator"),
                            i.classList.add("btn-success"),
                            i.classList.remove("btn-light"),
                            i.querySelector("i").classList.remove("d-none"),
                            i.querySelector(".indicator-label").innerHTML = "Following", i.disabled = !1
                        }), 1e3)
                })),
                KTUtil.on(document.body, '[data-kt-follow-btn="true"]', "click", (function (t) {
                    t.preventDefault();
                    var e = this, i = e.querySelector(".indicator-label"),
